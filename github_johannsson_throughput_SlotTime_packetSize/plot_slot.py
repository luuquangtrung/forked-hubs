...
for i in range(1, n+1):
    with open("logs/r%d_s12.txt" %i) as f:
        lines = f.readlines()
    ...
    with open("logs/r%d_s25.txt" %i) as f:
        lines = f.readlines()
    ...
    with open("logs/r%d_s30.txt" %i) as f:
        lines = f.readlines()
    ...
    with open("logs/r%d_s50.txt" %i) as f:
        lines = f.readlines()
...
ax.set_title('Varying the DCF slot time')
